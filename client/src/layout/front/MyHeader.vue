        ...
        <div class="flexDiv">
            ...
            <nav>
                <ul class="catalog">
                    ...
                    <router-link to="/creaters" tag="li">创作中心</router-link>
                    <router-link to="/articles" tag="li">博客中心</router-link>
                    <router-link to="/cloudmusic" tag="li">云音乐</router-link>
                    <router-link to="/contact" tag="li">支持</router-link>
                </ul>
            </nav>
        </div>
        <div class="container">
...
export default {
    ...
    methods: {
        ...
        search () {
            this.$router.push({name: 'SearchResult', params: {text: this.text}, hash: '#searcharticles'})
        }
    },
    watch: {
        $route () {
